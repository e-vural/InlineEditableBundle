...
class InlineEditableExtension extends AbstractExtension
{
    ...
    {
        return [
            new TwigFunction('inline_edit_input', [$this, 'renderInput'], [
                'is_safe' => ['html'],
            ]),
            new TwigFunction('inline_edit_textarea', [$this, 'renderTextarea'], [
                'is_safe' => ['html'],
            ]),
            new TwigFunction('inline_edit_select', [$this, 'renderSelect'], [
                'is_safe' => ['html'],
            ]),
        ];
    }
